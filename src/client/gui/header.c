...
/**
 * Handle activation of a chat list header.
 * Depending on the header type, it requests the list of users for a room, 
 * the public chat, or shows user information in a modal window.
 *
 * @param box The GtkListBox containing the header.
 * @param row The activated row.
 * @param user_data Pointer to a GtkBuilder used to retrieve widgets.
 **/
static void
